  ...
  const experiences = [
    {
      ...
      location: "Chennai",
      description: "Designed and developed Python-based projects that strengthened skills in logic building, GUI development, and problem-solving through hands-on work.", 
      icon: Briefcase,
    }
  ];
